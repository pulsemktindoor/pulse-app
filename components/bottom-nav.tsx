...
export function BottomNav() {
  ...
  return (
    <nav className="fixed bottom-0 left-0 right-0 z-50 flex md:hidden border-t border-white/[0.08] bg-black/70 backdrop-blur-xl pb-2 overflow-x-auto scrollbar-none">
      {navItems.map((item) => {
